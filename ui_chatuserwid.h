...
public:
    ...
    void setupUi(QWidget *ChatUserWid)
    {
        ...
        time_lb->setGeometry(QRect(-10, 20, 72, 15));
    ...
    void retranslateUi(QWidget *ChatUserWid)
    {
        ...
        user_name_lb->setText(QApplication::translate("ChatUserWid", "\344\270\203\346\243\256\344\270\203\344\270\203", nullptr));
        user_chat_lb->setText(QApplication::translate("ChatUserWid", "Hello World!", nullptr));
        time_lb->setText(QApplication::translate("ChatUserWid", "11:22", nullptr));
    } // retranslateUi
